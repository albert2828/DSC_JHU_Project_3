...
names(raw) <- sub("tBodyGyro", "time body angular acceleration", names(raw))
names(raw) <- sub("tGravityGyro", "time gravity angular acceleration", names(raw))
names(raw) <- sub("fBodyAcc", "frequency body linear acceleration", names(raw))
names(raw) <- sub("fBodyGyro", "frequency gyroscope angular acceleration", names(raw))
